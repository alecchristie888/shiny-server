    ...
    mainPanel(
      navbarPage("",id="maintabs",
                 ...
                 tabPanel("2. Gather evidence",id="tab03",value='tab03_val',
                          ...
                          h5(strong("Which action(s) could be taken to address the problem, regardless of their cost, acceptability, or feasibility?")),
                 ...
                 tabPanel(title="3. Make an evidence-based decision",id="tab13",value='tab13_val',
                          ...
                          br(),
                          h5(strong("Which action(s), if any, are not going to be implemented?")),
                          ...
                          br(),
                          h5(strong("What is your overall decision, what are the next steps, and why?")),
                          ...
                          br(),
                          br(),
                          h5("Your customised summary report"),
  ...
  observeEvent(input$add, {
    ...
    appendTab(inputId = "tab03_extra",
              tabPanel(title = glue("2.b-g ",id), id=glue("2.b-g ",id), value=glue("2.b-g ",id,"_val"),
                       ...
                       h5(strong("What does scientific evidence and local knowledge tell us about the desirable and undesirable effects of each action on the focal target?")),
                       ...
                       h5(strong("How locally effective is this action likely to be based on the available scientific evidence?")),
                       h5(strong("What is the overall certainty (quality) of the scientific evidence?")),
                       ...
                       h5(strong("How locally effective is this action likely to be based on local knowledge?")),
                       h5(strong("What is the overall certainty (quality) of local knowledge?")),
