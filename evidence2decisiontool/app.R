    ...
    mainPanel(width=9,
      navbarPage("",id="maintabs",
                 ...
                 tabPanel("1. Define the Decision Context",id="tab02",value='tab02_val',
                          ...
                          fixedRow(column(tippy("<strong> What is the ultimate goal? </strong>", tooltip = '<p style="font-size:15px"> This is the main objective that you want to achieve through any actions you decide to take as part of this decision. e.g., Reduce amphibian mortality but still enable the movement of frogs across the road.</p>', allowHTML=TRUE,placement="top"),
                            textAreaInput("action03",label=NULL,width="200%",height="200%",rows=3),width=12)),
                          fixedRow(column(tippy("<strong> What is the focal target? </strong>", tooltip = '<p style="font-size:15px"> This is the species, habitat, or population you are targeting to achieve your ultimate goal. e.g., Prevent the decline of a Natterjack toad (Epidalea calamita) population.</p>', allowHTML=TRUE,placement="top"),
